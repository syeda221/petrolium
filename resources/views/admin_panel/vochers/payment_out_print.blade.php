...
<head>
  ...
  <title>Payment Out - {{ $payment->id }}</title>
  <style>
  ...
  <div class="voucher">
    ...
    <div class="v-body">
      <div class="center">
        ...
        <div class="voucher-title">Payment Out Voucher</div>
      </div>
      <hr class="divider">
      <table class="info-table">
        <tr><td class="lbl">Voucher No</td><td class="val">POUT-{{ str_pad($payment->id, 4, '0', STR_PAD_LEFT) }}</td></tr>
