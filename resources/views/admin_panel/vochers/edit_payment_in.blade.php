...
<div class="main-content">
    <div class="container-fluid px-3 px-md-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold mb-1" style="color:var(--voucher-text);">Edit Payment In Voucher</h3>
                <p class="text-muted mb-0" style="font-size:13px;">Update payment received details</p>
            </div>
        ...
        <div class="voucher-form-card">
            ...
            @endif
            <form action="{{ route('payment.in.update', ['id' => $payment->id, 'type' => $type]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-voucher">
                        <i class="bi bi-check2-circle me-1"></i> Update Payment In
                    </button>
                </div>
            </form>
        </div>
