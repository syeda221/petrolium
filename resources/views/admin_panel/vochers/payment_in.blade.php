    ...
    <div class="row">
        <div class="col-md-5 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Receive money from a Customer (Customer balance will be reduced)</p>
                            ...
                            <tbody>
                                @foreach($payments as $payment)
                                    <tr>
                                        ...
                                        <td>{{ $payment->customer->customer_name ?? 'Unknown' }}</td>
                                        ...
                                        <td>
                                            ...
                                            <!-- Delete Button -->
                                            <form action="{{ route('payment.in.delete', $payment->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this payment? Customer ledger will be reverted.');">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    <div class="modal fade" id="editModal{{ $payment->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content text-left">
                                          <form action="{{ route('payment.in.update', $payment->id) }}" method="POST">
                                              @csrf
                                              @method('PUT')
                                              <div class="modal-header">
                                                <h5 class="modal-title">Edit Payment In</h5>
