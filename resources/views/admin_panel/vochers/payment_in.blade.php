                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" style="gap:2px;">
                                                ...
                                                <a href="{{ route('payment.in.print', ['id' => $payment->id, 'type' => $payment->party_type]) }}"
                                                ...
                                                <button type="button" class="btn btn-outline-danger btn-delete" title="Delete Voucher"
                                                    data-delete-url="{{ route('payment.in.delete', ['id' => $payment->id, 'type' => $payment->party_type]) }}"
                                                    data-delete-method="DELETE"
                                                    data-label="PIN-{{ str_pad($payment->id, 4, '0', STR_PAD_LEFT) }} (Payment In)">
