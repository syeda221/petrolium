                                ...
                                @foreach($payments as $payment)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Delete Button -->
                                            <form action="{{ route('payment.out.delete', ['id' => $payment->id, 'type' => $payment->party_type]) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this payment? Ledger will be reverted.');">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <div class="modal-content text-left">
                                          <form action="{{ route('payment.out.update', ['id' => $payment->id, 'type' => $payment->party_type]) }}" method="POST">
                                              ...
                                              <div class="modal-body">
                                                  ...
                                                  <div id="customer_id" class="form-group mb-2">
                                                      <label>Party</label>
